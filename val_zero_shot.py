...
if __name__ == '__main__':
    ...
    data = torch.load('saved_best_checkpoints/3_DA_saved_models/zero_shot/Base/m2_transformer_best.pth')
    ...
    dict_dataloader_val = DataLoader(dict_dataset_val, batch_size=args.batch_size)  # For zero_shot 
